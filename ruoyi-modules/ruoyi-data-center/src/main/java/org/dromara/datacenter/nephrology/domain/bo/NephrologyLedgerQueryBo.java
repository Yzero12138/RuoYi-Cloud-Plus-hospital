...
/**
 * Ledger query configuration bo.
 */
@Data
@EqualsAndHashCode(callSuper = true)
@AutoMapper(target = NephrologyLedgerQuery.class, reverseConvertGenerate = false)
public class NephrologyLedgerQueryBo extends BaseEntity {
